...
const softwareDeveloperSkillLevelDescriptors = {
    'Availability and capacity management': [
        ...
        {skillLevel: 'Practitioner',  description: 'You can ensure the correct implementation of standards and procedures. You can identify capacity issues, and stipulate and instigate the required changes. You can initiate remedial action.'},
        {skillLevel: 'Expert',        description: null},
    ],
    'Development process optimisation': [
        {skillLevel: 'Awareness',     description: 'You can explain the importance of developing process efficiency and the common ways in which processes are optimised. You can support specific activities to improve development processes. You can spot or identify obvious deficiencies.'},
        {skillLevel: 'Working',       description: 'You can identify process optimisation opportunities with guidance and contribute to the implementation of proposed solutions.'},
    ...
    'Development process optimisation (management)': [
        {skillLevel: 'Awareness',     description: null},
        {skillLevel: 'Working',       description: 'You can work under guidance to identify process optimisation opportunities. You can contribute to the implementation of proposed solutions.'},
        {skillLevel: 'Practitioner',  description: 'You can analyse current processes. You can identify and implement opportunities to optimise processes. You can lead and develop a team of experts to deliver service improvements. You can help to evaluate and establish requirements for the implementation of changes by setting policy and standards.'},
        {skillLevel: 'Expert',        description: 'You can set the strategy and manage resource allocation for solution development programmes. You can work with client functions to establish business requirements and identify, propose, initiate and lead these programmes.'},
    ],
    'Information security': [
        {skillLevel: 'Awareness',     description: 'You can discuss information security and the security controls that can be used to mitigate security threats within solutions and services.'},
        {skillLevel: 'Working',       description: 'You can demonstrate an understanding of information security and the types of security controls that can be used to mitigate security threats within solutions and services.'},
        {skillLevel: 'Practitioner',  description: 'You can understand information security. You can design solutions and services with security controls embedded, specifically engineered with mitigation of security threats as a core feature.'},
        {skillLevel: 'Expert',        description: 'You can demonstrate in-depth knowledge of information security. You can design, quality review and quality assure solutions and services with security controls embedded, specifically engineered with mitigation of security threats as a core feature.'},
    ],
    'Modern standards approach': [
        {skillLevel: 'Awareness',     description: 'You can understand the importance of adopting a modern standards approach.'},
        {skillLevel: 'Working',       description: 'You can explain the most important principles of a modern standards approach and how they apply to the work you are undertaking. You can apply these principles under guidance.'},
        {skillLevel: 'Practitioner',  description: 'You can competently apply a modern standards approach and guide others to do so.'},
        {skillLevel: 'Expert',        description: 'You can demonstrate a strong understanding of the most appropriate modern standards and practices, and how they are applied. You can coach and guide others in these standards.'},
    ],
    'Programming and build (software engineering)': [
        {skillLevel: 'Awareness',     description: null},
        {skillLevel: 'Working',       description: 'You can design, code, test, correct and document simple programs or scripts under the direction of others.'},
        {skillLevel: 'Practitioner',  description: 'You can collaborate with others when necessary to review specifications. You can use the agreed specifications to design, code, test and document programs or scripts of medium-to-high complexity, using the right standards and tools.'},
    ...
    'Prototyping': [
        {skillLevel: 'Awareness',     description: 'You can explain what prototyping is, and why and when to use it. You can understand how to work in an open and collaborative environment (by pair working, for example).'},
        {skillLevel: 'Working',       description: 'You can understand when to use a specific prototyping technique or method. You can show the value of prototyping to your team.'},
        {skillLevel: 'Practitioner',  description: 'You can approach prototyping as a team activity, actively soliciting prototypes and testing with others. You can establish design patterns and iterate them. You can use a variety of prototyping methods and choose the most appropriate.'},
        {skillLevel: 'Expert',        description: 'You can use a variety of prototyping methods. You can share best practice and coach others. You can look at strategic service design end to end.'},
    ],
    'Service support': [
        {skillLevel: 'Awareness',     description: 'You can help with the investigation and resolution of infrastructure problems, undertaking specific activities under direction.'},
        {skillLevel: 'Working',       description: 'You can help fix faults following agreed procedures. You can carry out agreed maintenance tasks on infrastructure.'},
        {skillLevel: 'Practitioner',  description: 'You can identify, locate and fix faults.'},
        {skillLevel: 'Expert',        description: null},
    ],
    'Systems design': [
        {skillLevel: 'Awareness',     description: 'You can assist as part of a team in the design of components of larger systems.'},
    ...
    'Systems integration': [
        {skillLevel: 'Awareness',     description: 'You can talk about the process of integrating systems and the challenges of designing, building and testing interfaces between systems.'},
        {skillLevel: 'Working',       description: 'You can build and test simple interfaces between systems. You can work on more complex integration as part of a wider team.'},
        {skillLevel: 'Practitioner',  description: 'You can define the integration build. You can co-ordinate build activities across systems. You can understand how to undertake and support integration testing activities.'},
        {skillLevel: 'Expert',        description: null},
    ],
    'User focus': [
        {skillLevel: 'Awareness',     description: 'You can show an awareness or understanding of user experience analysis and its principles. You can explain the purpose of user stories and the focus on user needs.'},
        {skillLevel: 'Working',       description: null},
